...
Page({
  ...
  openModule:function(e){
    ...
    wx.navigateTo({
      url: '/pages/community/module/page?activeIndex='+index,
    })
  },
  /**
   * 打开帖子
  ...
  openArticle: function (e) {
    ...
    let indexB = e.currentTarget.dataset.indexb;
    wx.navigateTo({
      url: '/pages/community/article/page',
  ...
  release:function(){
    const that = this;
    wx.navigateTo({
      url: '/pages/community/release/page',
      success: function (res) {
  ...
  openHot:function(e){
    ...
    wx.navigateTo({
      url: '/pages/community/article/page?id='+id,
      success: function (res) {
      },
      fail: function (res) { },
      complete: function (res) { },
  ...
  onShareAppMessage: function (e) {
    ...
    return {
      title: obj.title,
      path: 'pages/community/article/page?id='+obj.id,
